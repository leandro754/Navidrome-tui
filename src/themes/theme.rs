...
impl Default for Theme {
    fn default() -> Self {
        Theme {
            name: "Default (Violet)".into(),
            dark: true,
            primary_color: Color::Rgb(177, 133, 255), // violeta claro

            background: None,
            foreground: AutoColor::Fixed(Color::White),
            foreground_secondary: AutoColor::Fixed(Color::Rgb(180, 180, 180)),
            foreground_dim: AutoColor::Fixed(Color::Rgb(140, 140, 140)),
            foreground_disabled: AutoColor::Fixed(Color::Rgb(100, 100, 100)),
            section_title: AutoColor::Auto,
            accent: AutoColor::Auto,
            border: AutoColor::Fixed(Color::Rgb(60, 60, 60)),
            border_focused: AutoColor::Auto,
            selected_active_background: AutoColor::Auto,
            selected_active_foreground: AutoColor::Fixed(Color::Black),
            selected_inactive_background: AutoColor::Fixed(Color::Rgb(50, 50, 50)),
            selected_inactive_foreground: AutoColor::Fixed(Color::White),
            scrollbar_thumb: AutoColor::Auto,
            scrollbar_track: AutoColor::Fixed(Color::Rgb(30, 30, 30)),
            progress_fill: AutoColor::Auto,
